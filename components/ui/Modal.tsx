...
export default function Modal({
  ...
  return (
    <div className="fixed inset-0 z-[500] flex items-center justify-center select-none">
      ...
      <div
        className={`relative bg-white border border-gray-200 rounded-xl shadow-2xl p-6 w-full mx-4 z-[510] transition-all duration-300 scale-100 flex flex-col gap-4 ${widthStyles[width]}`}
        role="dialog"
        aria-modal="true"
      >
        ...
        {/* Center Body Section */}
        <div className="text-xs text-gray-700 leading-relaxed select-text py-1">
          {children}
        </div>
      </div>
    </div>
